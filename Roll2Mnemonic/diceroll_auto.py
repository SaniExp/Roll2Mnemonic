...
def roll_dice(n, num_rolls):  # n is the dice side numbers, num_rolls how many times to roll each number
    # secrets.randbelow() uses the operating system CSPRNG.
    ...
    while True:
        ...
        if is_valid_seed(current_mnemonic):
            ...
            print_red(f" You've chosen to generate a {num_words}-word mnemonic seed phrase."
                      ...
                      f"\n For each entropy bit, a cryptographically secure six-sided die roll is generated by the operating-system CSPRNG."
                      f"\n Odd rolls become 0 and even rolls become 1.")
            print()
